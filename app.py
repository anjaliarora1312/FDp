...
app = Flask(__name__)
app.secret_key = 'a'
conn = ibm_db.connect("DATABASE=bludb; HOSTNAME=1bbf73c5-d84a-4bb0-85b9-ab1a4348f4a4.c3n41cmd0nqnrk39u98g.databases.appdomain.cloud; PORT=32286; UID=wsc79439;PASSWORD=r6yH4fLwtIPrqFY9; SECURITY=SSL;SSLCertificate = DigiCertGlobalRootCA.crt", "", "")
    ...
    if request.method=="POST":
       for x in range (1,5):
        ...
        if f.filename != '':
            ...
            COS_API_KEY_ID = "SwsvdlpwyPhNpZYcGuEhYSAnYSDVwFNmughjQGa1vYv5"
            COS_INSTANCE_CRN = "crn:v1:bluemix:public:cloud-object-storage:global:a/8ca6edb47a6644e4a46e5ebb53ce1c63:0e0307d8-0787-446e-9904-5aa0da0565a0::"
            ...
            cos.meta.client.upload_file(Filename= filepath,Bucket='anjaliaroragkv',Key= u+x+".pdf")
...
def marksassign(stdname):
    ...
    output = cos.list_objects(Bucket="anjaliaroragkv")
    output
    l=[]
